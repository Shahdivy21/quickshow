...
const AdminSidebar = () => {
    ...
    const adminNavlinks = [
        ...
        { name: "Manage Shows", path: "/admin/manage-shows", icon: ListIcon },
    ...
    return (
        <div className='h-[calc(100vh-64px)] md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-white/10 text-sm bg-black/10 backdrop-blur-sm'>
